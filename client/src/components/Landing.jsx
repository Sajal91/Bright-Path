    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="absolute inset-x-0 top-[calc(100%-13rem)] -z-10 transform-gpu overflow-hidden blur-3xl sm:top-[calc(100%-30rem)]">
          <div className="relative left-[calc(50%+3rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 bg-gradient-to-tr from-blue-400 to-indigo-600 opacity-20 sm:left-[calc(50%+36rem)] sm:w-[72.1875rem]" />
        </div>
      </div>
          ...
          <div className="mt-20 grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="relative">
              ...
              <p className="mt-2 text-base text-gray-600">
                Our advanced algorithms analyze your interests, skills, and preferences to provide accurate career recommendations.
              </p>
            </div>
            ...
            <div className="relative">
              ...
              <p className="mt-2 text-base text-gray-600">
                Get tailored career paths based on your unique profile, including educational requirements and salary expectations.
              </p>
            </div>
            ...
            <div className="relative">
              ...
              <p className="mt-2 text-base text-gray-600">
                Access up-to-date information about career trends, job markets, and educational opportunities.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center">
            ...
            <div className="mt-8">
              <Link
                to="/signup"
                className="inline-flex items-center justify-center rounded-full py-4 px-8 text-sm font-semibold focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 bg-white text-gray-900 hover:bg-gray-100 active:bg-gray-200 focus-visible:outline-white transition-all duration-200 transform hover:scale-105"
              >
                Get Started Free
                <svg className="ml-2 h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center mb-4 md:mb-0">
              ...
              <span className="text-xl font-bold text-gray-900">Bright Path</span>
            </div>
